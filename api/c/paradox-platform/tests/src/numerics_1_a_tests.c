...
void paradox_platform_tests_numerics_1_a_hexadecimal_conversions(void)
{
    paradox_unit_tests_section_beg("Numerics: Hexadecimal Conversion");
    {
        ...
        PARADOX_UNIT_TEST_NUMERICS_HEX_TO_UINT_GOOD(64, 00FFFF0000FFFF0000, 16);
        ...
        PARADOX_UNIT_TEST_NUMERICS_HEX_TO_UINT_GOOD(32, 00FFFF0000, 8);
        ...
        PARADOX_UNIT_TEST_NUMERICS_HEX_TO_UINT_GOOD(16, 00FF00, 4);
        ...
        PARADOX_UNIT_TEST_NUMERICS_HEX_TO_UINT_GOOD(8, 00F0, 2);
